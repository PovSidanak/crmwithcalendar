...
@section('admin')
    <div class="page-content" style="background-color: aliceblue; justify-content: center;">
        ...
        <div class="card"
            style="background-color: aliceblue; box-shadow:none; display: flex;justify-content: center;">
            <div class="card-body">
                <div id="calendar"></div>
                    ...
                    <form id="myForm" method="POST" action="{{ route('store.schedules') }}" class="forms-sample">
                        ...
                        <div class="mb-3 form-group">
                            <label for="exampleInputEmail1" class="form-label"
                                style="color: gray;"><span>{{ __('Title') }}*</span></label>
                            <input type="text" id='title' name='title' class="form-control"
                                style="color: black;background-color:aliceblue" required>
                        </div>
                        <div class="mb-3 form-group">
                            <label for="exampleInputEmail1" class="form-label"
                                style="color: gray;"><span>{{ __('Start') }}*</span></label>
                        ...
                        <div class="mb-3 form-group">
                            <label for="exampleInputEmail1" class="form-label"
                                style="color: gray;"><span>{{ __('End') }}*</span></label>
                            <input type='date' id='end' name='end'value='{{ now()->toDateString() }}'
                                class="form-control" style="color: black;background-color:aliceblue" required>
                        </div>
                        <div class="mb-3 form-group">
                            <label for="exampleInputEmail1" class="form-label"
                                style="color: gray;"><span>{{ __('Description') }}*</span></label>
                        ...
                        <div class="mb-3 form-group">
                            <label for="exampleInputEmail1" class="form-label"
                                style="color: gray;"><span>{{ __('Color') }}*</span></label>
